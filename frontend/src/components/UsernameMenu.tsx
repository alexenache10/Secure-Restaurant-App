    ...
    if (storedEmail) {
        return (
            <div className="flex items-center">
                ...
                {
                    <Button onClick={handleAdminClick} className="ml-4 font-bold text-gray-500 hover:text-gray-700 transition duration-300 ease-in-out bg-gray-200 hover:bg-gray-300 py-2 px-4 rounded-lg">
                        Admin page
                    </Button>
                }
            </div>
